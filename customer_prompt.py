...
def getPrompt(custID, productID, customPrompt, credentials):
    ...
    context = 'My Name is Pramod Karhadkar. I am a Relationship manager working with DSDI Bank.My Mobile is +919923099230 and email is Pramod.K@dsdi.com. Use info related to me in signature with no inline spaces. I like to send a mail to the one of my customer regarding sales banking products. Following are the customer details'
